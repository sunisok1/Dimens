...
namespace Core.Maps.ConcreteMaps
{
    public class UltraFlatMap : AbstractMap
    {
        private readonly Dictionary<Entity, EntityObject> entityObjects = new();
        ...
        protected override void OnEntityCreated(object sender, EntityCreatedArgs e)
        {
        ...
        protected override void OnEntityMove(object sender, EntityMoveArgs e)
        {
